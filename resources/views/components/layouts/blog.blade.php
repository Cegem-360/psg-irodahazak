        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-screen-xl mx-auto">
            ...
            <div class="bg-white/10 rounded-xl overflow-hidden shadow-xl backdrop-blur-3xl">
                ...
                <div class="p-6 pl-8">
                    ...
                    <p class="text-gray-700 min-h-48">Ma már kutatások sora bizonyítja, hogy rendkívül súlyos
            ...
            <div class="bg-white/10 rounded-xl overflow-hidden shadow-xl backdrop-blur-3xl">
                ...
                <div class="p-6 pl-8">
                    ...
                    <p class="text-gray-700 min-h-48">Miközben napokon belül megkezdődik a konklávé a
            ...
            <div class="bg-white/10 rounded-xl overflow-hidden shadow-xl backdrop-blur-3xl">
                ...
                <div class="p-6 pl-8">
                    ...
                    <p class="text-gray-700 min-h-48">Kossuth Lajostól indult el, volt hozzá külön bevezető
