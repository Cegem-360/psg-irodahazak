    <div class="relative bg-cover bg-center bg-no-repeat"
        ...
        <div class="kiemelt-ajanlatok relative z-10 container mx-auto pt-12 pb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-screen-xl mx-auto">
                <div>
                    <x-layouts.cards.ingatlan-gallery-carousel :images="[
                        Vite::asset('resources/images/arena_corner_irodahaz_1__384x246.jpg'),
                        Vite::asset('resources/images/arena_corner_irodahaz_1__384x246.jpg'),
                        Vite::asset('resources/images/arena_corner_irodahaz_1__384x246.jpg'),
                    ]" title="Academia Irodaház" />
                </div>
