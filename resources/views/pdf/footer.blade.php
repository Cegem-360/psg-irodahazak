<style>
    ...
    *,
    ...
    select {
        ...
        .bg-\[\#404041\] {
            --tw-bg-opacity: 1;
            background-color: rgb(64 64 65 / var(--tw-bg-opacity, 1))
        }
        ...
        .bg-accentdark\/90 {
            background-color: hsl(var(--color-accentdark) / .9)
        }
        ...
        .bg-gray-200\/80 {
            background-color: rgba(var(--gray-200), .8)
        }
        ...
        .bg-logogray {
            background-color: rgb(var(--color-logogray))
        }
        ...
        .from-accentdark {
            --tw-gradient-from: hsl(var(--color-accentdark)) var(--tw-gradient-from-position);
            --tw-gradient-to: hsl(var(--color-accentdark) / 0) var(--tw-gradient-to-position);
        ...
        .from-gray-200 {
            --tw-gradient-from: rgba(var(--gray-200), 1) var(--tw-gradient-from-position);
            --tw-gradient-to: rgba(var(--gray-200), 0) var(--tw-gradient-to-position);
            --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to)
        }

        .from-gray-400 {
            --tw-gradient-from: rgba(var(--gray-400), 1) var(--tw-gradient-from-position);
            --tw-gradient-to: rgba(var(--gray-400), 0) var(--tw-gradient-to-position);
            --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to)
        }
        ...
        .from-primary\/80 {
            --tw-gradient-from: rgb(var(--color-primary) / .8) var(--tw-gradient-from-position);
            --tw-gradient-to: rgb(var(--color-primary) / 0) var(--tw-gradient-to-position);
            --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to)
        }
        ...
        .to-accent {
            --tw-gradient-to: hsl(var(--color-accent)) var(--tw-gradient-to-position)
        }

        .to-accent\/20 {
            --tw-gradient-to: hsl(var(--color-accent) / .2) var(--tw-gradient-to-position)
        }
        ...
        .to-gray-300 {
            --tw-gradient-to: rgba(var(--gray-300), 1) var(--tw-gradient-to-position)
        }

        .to-gray-900 {
            --tw-gradient-to: rgba(var(--gray-900), 1) var(--tw-gradient-to-position)
        }
        ...
        .to-primary\/60 {
            --tw-gradient-to: rgb(var(--color-primary) / .6) var(--tw-gradient-to-position)
        }
        ...
        .to-white\/70 {
            --tw-gradient-to: rgb(255 255 255 / .7) var(--tw-gradient-to-position)
        }
        ...
        .text-gray-300 {
            --tw-text-opacity: 1;
            color: rgba(var(--gray-300), var(--tw-text-opacity, 1))
        }
        ...
        .text-gray-900 {
            --tw-text-opacity: 1;
            color: rgba(var(--gray-900), var(--tw-text-opacity, 1))
        }
        ...
        .text-logogray {
            color: rgb(var(--color-logogray))
        }

        .text-logogray\/80 {
            color: rgb(var(--color-logogray) / .8)
        }
        ...
        .text-primary\/15 {
            color: rgb(var(--color-primary) / .15)
        }
        ...
        .ring-custom-600\/10 {
            --tw-ring-color: rgba(var(--c-600), .1)
        }

        .ring-custom-600\/20 {
            --tw-ring-color: rgba(var(--c-600), .2)
        }
        ...
        .ring-gray-600\/10 {
            --tw-ring-color: rgba(var(--gray-600), .1)
        }

        .ring-gray-900\/10 {
            --tw-ring-color: rgba(var(--gray-900), .1)
        }

        .ring-gray-900\/5 {
            --tw-ring-color: rgba(var(--gray-900), .05)
        }

        .ring-gray-950\/10 {
            --tw-ring-color: rgba(var(--gray-950), .1)
        }

        .ring-gray-950\/5 {
            --tw-ring-color: rgba(var(--gray-950), .05)
        }
        ...
        .hero-image:before {
            ...
            right: 0;
            bottom: 0;
            background: hsl(var(--color-accentdark));
            opacity: .95;
            z-index: 2;
            height: 100%;
            width: 100%;
            pointer-events: none;
            animation: heroReveal 2.2s cubic-bezier(.19, 1, .22, 1) forwards;
            animation-delay: 10s
        }
        ...
        .irs-to,
        .irs-single {
            background-color: rgb(var(--color-primary) / .8) !important;
            font-weight: 700 !important
        }

        .irs-handle {
            border-color: rgb(var(--color-primary) / .8) !important
        }
        ...
        li.jellemzok {
            list-style-image: url(/build/assets/psg-symbol-UIy-SfbG.svg)
        }
        ...
        .reference-button-next:hover,
        .reference-button-prev:hover,
        .rolunkmondtak-button-next:hover,
        .rolunkmondtak-button-prev:hover,
        .kiemelt-button-next:hover,
        .kiemelt-button-prev:hover,
        .minicarousel-button-next:hover,
        .minicarousel-button-prev:hover {
        ...
        .hover\:bg-accent\/70:hover {
            background-color: hsl(var(--color-accent) / .7)
        }

        .hover\:bg-accent\/80:hover {
            background-color: hsl(var(--color-accent) / .8)
        }

        .hover\:bg-accent\/90:hover {
            background-color: hsl(var(--color-accent) / .9)
        }
        ...
        .hover\:bg-gray-100\/75:hover {
            background-color: rgba(var(--gray-100), .75)
        }
        ...
        .focus\:ring-accent:focus {
            --tw-ring-color: hsl(var(--color-accent))
        }
        ...
        .checked\:focus\:ring-danger-500\/50:focus:checked {
            --tw-ring-color: rgba(var(--danger-500), .5)
        }
        ...
        .focus-visible\:ring-custom-500\/50:focus-visible {
            --tw-ring-color: rgba(var(--c-500), .5)
        }
        ...
        .focus-visible\:ring-gray-400\/40:focus-visible {
            --tw-ring-color: rgba(var(--gray-400), .4)
        }
        ...
        .dark\:border-gray-900:is(.dark *) {
            --tw-border-opacity: 1;
            border-color: rgba(var(--gray-900), var(--tw-border-opacity, 1))
        }
        ...
        .dark\:bg-gray-950\/95:is(.dark *) {
            background-color: rgba(var(--gray-950), .95)
        }
        ...
        .dark\:ring-custom-400\/30:is(.dark *) {
            --tw-ring-color: rgba(var(--c-400), .3)
        }
        ...
        .dark\:ring-gray-400\/20:is(.dark *) {
            --tw-ring-color: rgba(var(--gray-400), .2)
        }

        .dark\:ring-gray-50\/10:is(.dark *) {
            --tw-ring-color: rgba(var(--gray-50), .1)
        }
        ...
        .dark\:ring-gray-800:is(.dark *) {
            --tw-ring-opacity: 1;
            --tw-ring-color: rgba(var(--gray-800), var(--tw-ring-opacity, 1))
        }
        ...
        .dark\:hover\:bg-gray-800\/75:hover:is(.dark *) {
            background-color: rgba(var(--gray-800), .75)
        }
        ...
        .dark\:checked\:focus\:ring-danger-400\/50:focus:checked:is(.dark *) {
            --tw-ring-color: rgba(var(--danger-400), .5)
        }
        ...
        .dark\:focus-visible\:ring-custom-400\/50:focus-visible:is(.dark *) {
            --tw-ring-color: rgba(var(--c-400), .5)
        }
...
<div class="footer text-black" style="width: 100%; text-align: center;">
    ...
    <p class="contact-line" style="font-size: 16px; font-weight: bold;">
        <a href="mailto:richard.fekete@psg-irodahazak.hu">
